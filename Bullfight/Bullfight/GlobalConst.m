...
+(UIColor *)appBgColor
{
    return [UIColor colorWithRed:21.0f/255.0f green:42.0f/255.0f blue:61.0f/255.0f alpha:1.0];
}
...
{
    return [UIColor colorWithRed:34.0f/255.0f green:58.0f/255.0f blue:79.0f/255.0f alpha:1.0];
}
...
+(UIColor*)orangeColor
{
    return [UIColor colorWithRed:247.0f/255.0f green:79.0f/255.0f blue:53.0f/255.0f alpha:1.0];
}
